...
<div class="container">
    <h2>Thống Kê</h2>
    <ul>
        <li><a href="#">Thống Kê Món Ăn Theo Doanh Thu</a></li>
        <li><a href="GDTKKhachTheoDoanhThu.jsp">Thống Kê Khách Hàng Theo Doanh Thu</a></li>
        <li><a href="#">Thống Kê Nhà Cung Cấp Theo Số Lượng Hàng Nhập</a></li>
        <li><a href="#">Thống Kê Nguyên Liệu</a></li>
    </ul>
</div>
</body>
</html>